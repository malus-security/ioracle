...
do
    ...
    filePath="/Users/luke/Desktop/iOS/iOSAppCollection/decryptedApps/$line"

    identifier=`codesign --display --verbose=4 $filePath 2>&1 | grep -o '^Identifier=.*' | sed 's/Identifier=//'`

...
scriptDirectory=../scriptsToAutomate
...
time $scriptDirectory/fileTypeExtractor.sh $extractionDirectory/fileSystem > $extractionDirectory/prologFacts/unsanitized_file_types.pl
time $scriptDirectory/sanitizeFilePaths.py $extractionDirectory/prologFacts/unsanitized_file_types.pl > $extractionDirectory/prologFacts/file_types.pl

echo 'getting user data'
echoerr 'getting user data'
#extract data about users from etc
time $scriptDirectory/userFactExtractor.sh $extractionDirectory/fileSystem > $extractionDirectory/prologFacts/users.pl

echo 'getting group data'
echoerr 'getting group data'
#extract data about groups from etc
time $scriptDirectory/groupFactExtractor.sh $extractionDirectory/fileSystem > $extractionDirectory/prologFacts/groups.pl

echo 'getting file paths of Mach-O executables'
echoerr 'getting file paths of Mach-O executables'
cat $extractionDirectory/prologFacts/file_types.pl $scriptDirectory/queries.pl > $temporaryFiles/relevantFacts.pl
time $scriptDirectory/runProlog.sh justPaths $temporaryFiles > $temporaryFiles/filePaths.out
...
time $scriptDirectory/signatureExtractor.sh $extractionDirectory/fileSystem < $temporaryFiles/filePaths.out > $extractionDirectory/prologFacts/apple_executable_files_signatures.pl
...
cat $extractionDirectory/prologFacts/apple_executable_files_signatures.pl $scriptDirectory/queries.pl > $temporaryFiles/relevantFacts.pl
time $scriptDirectory/runProlog.sh justApplePaths $temporaryFiles > $temporaryFiles/applefilePaths.out
rm $temporaryFiles/relevantFacts.pl
...
time $scriptDirectory/entitlementExtractor.sh $extractionDirectory/fileSystem < $temporaryFiles/applefilePaths.out > $extractionDirectory/prologFacts/apple_executable_files_entitlements.pl

echo 'getting strings for Apple-Signed Mach-O executables'
echoerr 'getting strings for Apple-Signed Mach-O executables'
time $scriptDirectory/stringExtractor.sh $extractionDirectory/fileSystem < $temporaryFiles/applefilePaths.out > $extractionDirectory/prologFacts/apple_executable_files_strings.pl

echo 'getting symbols for Apple-Signed Mach-O executables'
echoerr 'getting symbols for Apple-Signed Mach-O executables'
time $scriptDirectory/symbolExtractor.sh $extractionDirectory/fileSystem < $temporaryFiles/applefilePaths.out > $extractionDirectory/prologFacts/apple_executable_files_symbols.pl
...
cat $extractionDirectory/prologFacts/apple_executable_files_signatures.pl $extractionDirectory/prologFacts/apple_executable_files_entitlements.pl $scriptDirectory/queries.pl > $temporaryFiles/relevantFacts.pl
time $scriptDirectory/runProlog.sh getProfilesFromEntitlementsAndPaths $temporaryFiles > $temporaryFiles/profileAssignmentFromEntAndPath.pl
rm $temporaryFiles/relevantFacts.pl
...
cat $extractionDirectory/prologFacts/apple_executable_files_symbols.pl $scriptDirectory/queries.pl > $temporaryFiles/relevantFacts.pl
time $scriptDirectory/runProlog.sh getSelfAssigningProcessesWithSymbols $temporaryFiles > $temporaryFiles/pathsToSelfAssigners.out
rm $temporaryFiles/relevantFacts.pl
...
time $scriptDirectory/idaBatchAnalysis.sh $extractionDirectory/fileSystem/ $temporaryFiles/pathsToSelfAssigners.out $temporaryFiles/
...
time $scriptDirectory/mapIdaScriptToTargets.sh $temporaryFiles/hashedPathToFilePathMapping.csv $scriptDirectory/strider.py $temporaryFiles/ $temporaryFiles/sandboxInit.out ./configurationFiles/sandboxInit.config
time $scriptDirectory/mapIdaScriptToTargets.sh $temporaryFiles/hashedPathToFilePathMapping.csv $scriptDirectory/strider.py $temporaryFiles/ $temporaryFiles/sandboxInitWithParameters.out ./configurationFiles/sandboxInitWithParameters.config
time $scriptDirectory/mapIdaScriptToTargets.sh $temporaryFiles/hashedPathToFilePathMapping.csv $scriptDirectory/strider.py $temporaryFiles/ $temporaryFiles/applyContainer.out ./configurationFiles/applyContainer.config
...
cat $temporaryFiles/selfApplySandbox.pl $scriptDirectory/queries.pl > $temporaryFiles/relevantFacts.pl
time $scriptDirectory/runProlog.sh parseSelfAppliedProfiles $temporaryFiles > $temporaryFiles/parsedFilteredSelfAppliers.pl
rm $temporaryFiles/relevantFacts.pl
